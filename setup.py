...
from Janelas.frontCads import cadClientes, cadEmpresa
...
class Application(
    ...
    conector.Conector,
    frontend.Tela,
    cadClientes.Clientes,
    multilang.Lang,
    colors.Colors,
    cadFornec.Fornecedores,
    cadTec.Tecnicos,
    validadores.Validadores,
    cadProd.Produtos,
    cadServ.Servicos,
    license.Data_company,
    cadMarcaProd.MarcaProdutos,
    atualizaMaodeObra.MaodeObra,
    cadEmpresa.Empresa,
    cadEstoque.Estoque,
    consFinan.Financeiro,
    cadPagamento.PagamentoOrc,
    editItem.EditItens,
    backAba2Front.Aba2, backSegundoFrame.SegundoFrame):
    def __init__(self):
        self.montaTabelas()
        self.cores()
        self.dados()
