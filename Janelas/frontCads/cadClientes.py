...
class Clientes(CadCli):
    ...
    def telaCliente(self):
        ...
        self.janelaCli.geometry("800x650")
    ...
    def molduraCliente(self):
        ...
        self.tituloListaClientes.place(relx=0.01, rely=0.55,
    ...
    def WidgetsClientes(self):
        ...
        self.fone1PeEntry.place(relx=0.04, rely=0.37,
                                relwidth=0.06, relheight=0.03)
        ...
        self.fone1PeEntry2.place(relx=0.12, rely=0.37,
                                 relwidth=0.24, relheight=0.03)

        #'Label Fone 2'
        self.fone2Pelabel = LabelGlac(self.janelaCli)
        self.fone2Pelabel.configure(font=('Verdana', '8', 'bold'),
                                    text='Fone 2')
        self.fone2Pelabel.place(relx=0.48, rely=0.35,
                                relwidth=0.12, relheight=0.02)
        ...
        self.fone2PeEntry.configure(font=('Verdana', '8', 'bold'),
                                    validate="key",
                                    validatecommand=self.vcmd2)
        self.fone2PeEntry.place(relx=0.48, rely=0.37,
                                relwidth=0.06, relheight=0.03)
        ...
        self.fone2PeEntry2.configure(font=('Verdana', '8', 'bold'),
                                     validate="key",
                                     validatecommand=self.vcmd12)
        self.fone2PeEntry2.place(relx=0.56, rely=0.37,
                                 relwidth=0.24, relheight=0.03)
        ...
        self.cpfPeLabel.place(relx=0.62, rely=0.4,
                              relwidth=0.1, relheight=0.02)
        ...
        self.cpfPeEntry.configure(font=('Verdana', '8', 'bold'),
                                  validatecommand=self.vcmd12)
        self.cpfPeEntry.place(relx=0.62, rely=0.42,
                              relwidth=0.32, relheight=0.03)
        ...
        self.cnpjPeLabel.place(relx=0.28, rely=0.4,
                               relwidth=0.1, relheight=0.02)
        ...
        self.cnpjPeEntry.configure(font=('Verdana', '8', 'bold'),
                                   validate="key",
                                   validatecommand=self.vcmd12)
        self.cnpjPeEntry.place(relx=0.28, rely=0.42,
                               relwidth=0.32, relheight=0.03)
        ...
        self.cepPeBt.configure(text='>>',
                               command=self.cep)
        self.cepPeBt.place(relx=0.04, rely=0.42,
                           relwidth=0.08, relheight=0.03)
        ...
        self.cepPeLabel.configure(font=('Verdana', '8', 'bold'),
                                  text=self.m_Cep)
        self.cepPeLabel.place(relx=0.04, rely=0.4,
                              relwidth=0.12, relheight=0.02)
        ...
        self.cepPeEntry.configure(validate="key",
                                  font= ('Verdana', 8),
                                  validatecommand=self.vcmd8)
        self.cepPeEntry.place(relx=0.12, rely=0.42,
                              relwidth=0.14, relheight=0.03)

        #'Botao Novo Cliente'
        self.botaoAdd = ButtonGlac(self.janelaCli)
        self.botaoAdd.configure(text=self.m_Novo,
                                command=self.add_clienteC)
        self.botaoAdd.place(relx=0.5, rely=0.08,
                            width=60, height=25)
        ...
        self.botaoMud.configure(command=self.mud_clienteC,
                                text=self.m_Alterar)
        self.botaoMud.place(relx=0.66, rely=0.08,
                            width=60, height=25)
        ...
        self.botaoDel.place(relx=0.82, rely=0.08,
                            width=60, height=25)
        ...
        self.botaolimpa.place(relx=0.34, rely=0.08,
                              width=60, height=25)
        ...
        self.botaobusca.place(relx=0.22, rely=0.08, width=35)
    def listaClientes(self):
        ...
        self.listaServ.column("#1", width=30)
        self.listaServ.heading("#2", text=self.m_Nome)
        self.listaServ.column("#2", width=300)
        self.listaServ.heading("#3", text='Prefixo')
        self.listaServ.column("#3", width=20)
        self.listaServ.heading("#4", text=self.m_Fone)
        self.listaServ.column("#4", width=135)

        self.listaServ.place(relx=0.02, rely=0.61,
                             relwidth=0.93, relheight=0.35)
        self.listaServ.configure(yscroll=self.barracliente.set)
        self.barracliente.place(relx=0.95, rely=0.61,
                                relwidth=0.025, relheight=0.35)
