...
class Servicos(CadServ):
    def cadserv(self):
        ...
        self.janelaServ.geometry("920x390")
        ...
        self.descrTipoServ.place(x=445, y=60, width=80, height=25)

        self.entradaTipoServ = EntPlaceHold(self.janelaServ, '')
        self.entradaTipoServ.place(x=525, y=60, width=200, height=25)
        ...
        self.listaServ.heading("#7", text= "")
        self.listaServ.heading("#8", text= self.m_Tipo)
        self.listaServ.heading("#9", text= "")
        ...
        self.listaServ.column("#6", width=1)
        self.listaServ.column("#7", width=1)
        self.listaServ.column("#8", width=110)
        self.listaServ.column("#9", width=1)
        ...
        self.barra.place(x=895, y=150, width=20, height=230)
        ...
        self.listaServ.place(x=15, y=150, width=880)
