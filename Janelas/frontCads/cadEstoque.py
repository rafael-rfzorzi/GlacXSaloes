...
class Estoque(CadEstoque):
    def cadest(self):
        ...
        data_aba2label.configure(
            text=self.m_Data + self.m_Pontinhos + self.m_DataMasc)
        data_aba2label.place(x=20, y=140, width=180, height=25)

        self.dia_aba2 = Entry(frame_aba2)
        self.dia_aba2.configure(validate="key", validatecommand=self.vcmd2)
        self.dia_aba2.place(x=90, y=140, width=20, height=15)

        self.mes_aba2 = Entry(frame_aba2)
        self.mes_aba2.configure(validate="key",
                              validatecommand=self.vcmd2)
        self.mes_aba2.place(x=120, y=140, width=20, height=15)

        self.ano_aba2 = Entry(frame_aba2)
        self.ano_aba2.configure(validate="key", validatecommand=self.vcmd4)
        self.ano_aba2.place(x=150, y=140, width=40, height=15)
        ...
        self.diaV_aba2.place(x=100, y=200, width=20, height=20)

        self.mesV_aba2 = Entry(frame_aba2)
        self.mesV_aba2.configure(validate="key", validatecommand=self.vcmd2)
        self.mesV_aba2.place(x=130, y=200, width=20, height=20)

        self.anoV_aba2 = Entry(frame_aba2)
        self.anoV_aba2.configure(validate="key", validatecommand=self.vcmd4)
        self.anoV_aba2.place(x=160, y=200, width=40, height=20)
