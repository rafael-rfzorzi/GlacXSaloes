...
class Tela(relatorios.PrintRel, BuscaOrc, BuscaTecnico, Busca_Serv,
           BuscaCliente, Calendario):
    # Tela Principal do Aplicativo
    def tela(self):
        # Window assembly
        self.janela = janela
        self.janela.title("Serviços e agendamento - Glac")
    ...
    def altera_itens_orc(self, *args):
        ...
        self.ordemItemL.configure(text='Ordem')
        ...
        self.descrItemL.configure(text='Descrição')
        ...
        self.codigoItemL.configure(text='Código')
        ...
        self.valorItemL.configure(text='R$ Valor')
        ...
        self.quantItemL.configure(text='Quant',
        ...
        self.totalItemL.configure(text='R$ Total')
        ...
        self.altera_itenBt.configure(text='Alterar Registro',
        ...
        self.deleta_itenBt.configure(text='Excluir Registro',
